...
class CustomButton extends GetWidget<AuthViewModel>{
  ...
  CustomButton({this.text='', this.fw=FontWeight.w500, this.color=Colors.white, this.textcolor=Colors.white, this.left = 140, this.right = 140, this.between=50, this.pic="lib/Images/0.png"});
